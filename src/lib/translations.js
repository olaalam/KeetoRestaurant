const translations = {
  en: {
    ...
    "checkDetails": "Check Details",
    "close": "Close",
    "newOrdersCountMessage": "You have {count} new orders, please check.",
    orderCancelledTitle: "order Cancelled Title",
    orderCancelledDesc: "order Cancelled Desc",
    ...
    addons_tab2: "Addons",
    "visaReport": "Visa Payments Report",
  "reviewingVisaAnalytics": "Reviewing online payments and orders analytics",
  ...
  "pending": "Pending",
  "failed": "Failed",
  "totalVisaRevenueAndOrders": "Total Revenue & Orders",
  "successfulPayments": "Successful Payments",
  "failedPayments": "Failed Payments",
  "currency": "EGP",
  "orders": "Orders",
  "paidViaVisa": "Paid via Card",
  "orderNumber": "Order #",
  "customer": "Customer",
  "branch": "Branch",
  "gateway": "Gateway",
  ...
  "ordersList": "Payments Log",
    ...
    withDeliveryMan: " With Delivery Man",

    cashDeliveryOrdersTitle: "Cash Delivery Orders",
    ...
    noOrdersToCollect: " No orders to collect for this delivery man.",
    assignOrdersToDeliveryMan: "Assign orders to delivery man",
    ...
    "transactionsHistory": "Transactions History",
    "transactionId": "Transaction ID",
    noDeliveryManSelected: "No delivery man selected",
    selectDeliveryManFirst: "Please select a delivery man first",
    "amount": "Amount",
    "date": "Date",
    "method": "Method",
    "egp": "EGP",
    ...
    next: "Next",
    viewInvoice: "Invoice",
    viewInvoiceLong: "View Invoice",
    delivery: "Delivery",
    takeaway: "Takeaway",
    onlineOrder: "Online Order",
    "Online Order Web": "Online Order Web",
    pending: "Pending",
    accepted: "Accepted",
    preparing: "Preparing",
    outForDelivery: "Out for Delivery",
    ...
    edit: "Edit",
    selectDeliveryManFirst: "Please select a delivery man first",
    deliveryManAssignedSuccess: "Delivery man details saved successfully",
    ...
    outfordelivery: "Out for Delivery",
    assigndeliveryman: "Assign Delivery Man",
    collectdeliverycash: "Collect Delivery Cash",
    pendingOrders: "Pending Orders",
    deliveryManagement: "Delivery Management",
    "collectDeliveryCash": "Collect Delivery Cash",
    "selectDeliveryMan": "Select Delivery Man:",
    "allOrders": "All (Default / All Orders)",
    "loading": "Loading...",
    ...
    "pending": "Pending",
    "delivered": "Delivered",
    "selectDeliveryManFirst": "Please select a specific delivery man first to collect cash.",
    "noOrdersToCollect": "No pending orders to collect for this delivery man.",
    "cashCollectedSuccess": "Cash collected! Auto-switched to:",
    "cashCollectedEnd": "Cash collected successfully. No more delivery men in the list.",
    ...
    "deliveryManagement": "Delivery Management",
    "deliveryManagementSub": "Monitor drivers, assigned orders, and cash collection",
    "branchId": "Branch ID",
    "activeDeliveryMen": "Active Drivers",
    "active": "Active",
    "loading": "Loading...",
    "noActiveDeliveryMen": "No active drivers available",
    "pendingOrdersTitle": "Pending Orders (Accepted / Preparing)",
    "orders": "Orders",
    "noPendingOrders": "No pending orders for this branch",
    "deliveryOrders": "Driver Orders",
    "deselectAll": "Deselect All",
    "selectAll": "Select All",
    "selectDeliveryManToView": "Select a driver to view assigned orders",
    "noOrdersForStatus": "No orders with this status for the selected driver",
    "noteTitle": "Collection / Receipt Notes",
    "enterNotePlaceholder": "Enter note...",
    "defaultCollectionNote": "Full amount received from driver",
    "totalOrdersSelected": "Total Selected Orders",
    "totalCashSelected": "Total Cash of Selected Orders",
    "remainingCashWithDriver": "Remaining Cash with Driver",
    "collectSelectedCash": "Collect Selected Amount",
    "selectDeliveryManFirst": "Please select a delivery driver first",
    "selectOrdersFirst": "Please select at least one order",
  ...
  ar: {
    ...
    viewInvoiceLong: "عرض الفاتورة",
    delivery: "توصيل",
    takeaway: "استلام",
    onlineOrder: "طلب أونلاين",
    "Online Order Web": "طلب أونلاين عبر الويب",
    pending: "قيد الانتظار",
    accepted: "تم القبول",
    preparing: "قيد التحضير",
    ...
    deliveryTypeTitle: "التوصيل",

    // Order Items Section
    orderItemsTitle: "مكونات الطلب",
    product: "المنتج",
    variations: "الخيارات",
    ...
    // Payment Summary Section
    paymentSummary: "ملخص الحساب للفاتورة",
    subtotal: "المجموع الفرعي",
    serviceFee: "رسوم الخدمة",
    deliveryFee: "رسوم التوصيل",
    freeDelivery: "توصيل مجاني",
    discountAmount: "قيمة الخصم",
    couponCode: "كود الخصم المستخدم",
    ...
    orders: "الطلبات",
    assignDeliveryMan: "تعيين مندوب توصيل",
    edit: "تعديل",
    selectDeliveryManFirst: "يرجى اختيار مندوب توصيل أولاً",
    deliveryManAssignedSuccess: "تم حفظ بيانات المندوب بنجاح",
    assignDeliveryError: "فشل في تعيين مندوب توصيل",
    searchDeliveryMan: "بحث بالاسم أو رقم الهاتف...",
    noResultsFound: "لا توجد نتائج مطابقة",

    // Preparation Duration Section
    orderDuration: "مدة التحضير",
    remainingTime: "الوقت المتبقي:",
    addOrEdit: "إضافة / تعديل",
    setPreparationTime: "تحديد وقت التحضير",
    durationInMinutes: "الوقت التقديري للتحضير (بالدقائق)",
    cancel: "إلغاء",
    confirm: "تأكيد وبدء التحضير",
    durationUpdatedSuccess: "تم تحديد وقت التحضير بنجاح",
    durationUpdateError: "فشل في تحديد وقت التحضير",

    // Change Status & Actions
    changeOrderStatus: "تعديل حالة الطلب",
    "change Order Status": "تعديل حالة الطلب",
    ...
    failedToDownloadInvoice: "فشل في تحميل الفاتورة",
    orderNotFound: "الطلب غير موجود",
    address: "العنوان",
    Order: "رقم الطلب",
    CheckDetails: "تحقق من التفاصيل",
    perUserLimit: "الحد الأقصى لكل مستخدم",
    "checkDetails": "فحص التفاصيل",
    "close": "إغلاق",
    "newOrdersCountMessage": "لديك {count} تنبيه طلب جديد، يرجى التحقق.",
    orderCancelledTitle: "عنوان إلغاء الطلب",
    orderCancelledDesc: "وصف إلغاء الطلب",
    cancelReasonLabel: "سبب إلغاء الطلب",
    "visaReport": "تقرير مدفوعات البطاقات",
  "reviewingVisaAnalytics": "مراجعة وتحليل عمليات الدفع الإلكتروني والطلبات",
  "exportPDF": "تصدير PDF",
  ...
  "pending": "قيد الانتظار",
  "failed": "مرفوض",
  "totalVisaRevenueAndOrders": "إجمالي الإيرادات والطلبات",
  "successfulPayments": "المدفوعات الناجحة",
  "failedPayments": "المدفوعات المرفوضة",
  "currency": "ج.م",
  "orders": "طلبات",
  "paidViaVisa": "تم الدفع عبر البطاقة",
  "orderNumber": "رقم الطلب",
  "customer": "العميل",
  "branch": "الفرع",
  "gateway": "بوابة الدفع",
  ...
  "ordersList": "سجل المدفوعات",
    ...
    DeliveryAccounts: "حسابات التوصيل",
    collectdeliverycash: "تحصيل كاش التوصيل",
    ...
    "zonesTitle": "المناطق",
    "cityHeader": "المدينة",
    assignOrdersToDeliveryMan: "تعيين الطلبات لمندوب التوصيل",
    ...
    "deliveryManagement": "إدارة توصيل الطلبات",
    "deliveryManagementSub": "متابعة المندوبين والطلبات المسندة وتحصيل المبالغ",
    "branchId": "معرف الفرع",
    "activeDeliveryMen": "مندوبي التوصيل النشطين",
    "active": "نشط",
    "loading": "جاري التحميل...",
    "noActiveDeliveryMen": "لا يوجد مندوبين نشطين حالياً",
    "pendingOrdersTitle": "الطلبات المعلقة (مقبولة / تحضير)",
    "orders": "طلب",
    "noPendingOrders": "لا توجد طلبات معلقة لهذا الفرع",
    "deliveryOrders": "طلبات المندوب",
    "deselectAll": "إلغاء الكل",
    "selectAll": "تحديد الكل",
    "selectDeliveryManToView": "اختر مندوباً من الجزء الأول لعرض طلباته",
    "noOrdersForStatus": "لا توجد طلبات بهذا الوضع للمندوب المحدد",
    "noteTitle": "ملاحظات الاستلام / التحصيل",
    "enterNotePlaceholder": "أدخل ملاحظات...",
    "defaultCollectionNote": "تم استلام المبلغ بالكامل من الديلفري",
    "totalOrdersSelected": "إجمالي الطلبات المختارة",
    "totalCashSelected": "إجمالي المبالغ المختارة",
    "remainingCashWithDriver": "النقدية المتبقية مع المندوب",
    "collectSelectedCash": "تحصيل المبالغ المختارة",
    "selectDeliveryManFirst": "يرجى اختيار مندوب أولاً",
    "selectOrdersFirst": "يرجى تحديد طلب واحد على الأقل",
    ...
    "statusPending": "معلق",
    "filterAll": "الكل",
    "filterOutForDelivery": "قيد التوصيل",
    "filterDelivered": "تم التسليم",
    "customer": "عميل",
    "noAddress": "بدون عنوان",
    "unknownPayment": "غير معروف",
    "subtotal": "الفرعي",
    "deliveryFee": "التوصيل",
    "currencyEGP": "ج.م",
    "collectDeliveryCash": "تحصيل نقدية عمال التوصيل",
    "selectDeliveryMan": "اختر عامل التوصيل:",
    "allOrders": "الكل (افتراضي / كل الطلبات)",
    "loading": "جاري التحميل...",
    "collectionNote": "ملاحظة التحصيل...",
    "collectCash": "تحصيل النقدية",
    "totalOrders": "إجمالي الطلبات",
    "totalCash": "إجمالي النقدية المسلمة",
    "cashOnHand": "العهدة مع العامل",
    "orderNumber": "رقم الطلب",
    "customerName": "اسم العميل",
    "amount": "المبلغ",
    "currency": "ج.م",
    ...
    "pending": "قيد الانتظار",
    "delivered": "تم التوصيل",
    "selectDeliveryManFirst": "يرجى تحديد عامل توصيل محدد أولاً لإتمام التحصيل.",
    "noOrdersToCollect": "لا توجد طلبات معلقة لتحصيلها لهذا العامل.",
    ...
    noDeliveryManSelected: "لم يتم اختيار عامل توصيل",
    selectDeliveryManFirst: "يرجى اختيار عامل توصيل أولاً",
    noOrdersToCollect: "لا توجد طلبات لتحصيلها لهذا العامل",
