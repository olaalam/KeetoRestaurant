...
export default function OrderDetails() {
  ...
  // حالات السيرش والقائمة المنسدلة الجديدة
  ...
  const updateStatusMutation = useMutation({
    mutationFn: async ({ status, cancelReasonId, customReason }) => {
      // بنجهز الـ payload الأساسي
      const payload = { status };

      // لو باعت ID بنضيفه، لو باعت customReason بنضيفه (ومش بنبعت الـ ID)
  ...
  // فلترة المندوبين بناءً على السيرش
  ...
  return (
    <div className="w-full mx-auto py-8 px-4 sm:px-6 space-y-6">
        ...
        <div className="space-y-6 xl:col-span-2">
          ...
          <Card className="rounded-2xl border shadow-sm bg-white">
            ...
            <CardContent className="p-6 space-y-3.5">
              ...
              {/* رسوم التوصيل (تظهر كـ Free Delivery أو القيمة العادية حسب الشرط بدون تكرار) */}
              ...
              {/* عرض كود الخصم إذا كان موجوداً فقط */}
        ...
        <div className="space-y-6 xl:col-span-1">
          <Card className="rounded-2xl border border-gray-100 shadow-sm bg-white p-6">
            ...
            <div className="space-y-2 text-sm text-gray-800">
              {/* اسم العميل + إجمالي الطلبات بجانبه */}
              <div className="flex items-center gap-3 flex-wrap">
                ...
                <div className="text-xs font-semibold text-gray-600 bg-gray-100 border border-gray-200 px-2.5 py-0.5 rounded-md shadow-2xs">
                  ...
                  <span className="font-bold text-gray-900">
                    {order.customer?.totalOrders ?? order.totalOrder ?? 0}
                  </span>
                </div>
              </div>
      ...
      {/* Dialog تعيين مندوب التوصيل المحدث (Searchable Dropdown) */}
      <Dialog
          ...
          <div className="py-4 space-y-3">
            ...
            {isDeliveryLoading ? (
              ...
              <div className="relative w-full">
                ...
                {/* القائمة المنسدلة وبداخلها البحث */}
      ...
      <ReasonDialog
        ...
        // الـ data هنا هتكون إما { cancelReasonId: id } أو { customReason: "السبب" }
        onConfirm={(data) =>
