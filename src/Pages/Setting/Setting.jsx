...
export default function Setting() {
    ...
    const columns = [
        ...
        },
        {
            ...
            header: t("isTemporarilyClosed", { defaultValue: "Temporarily Closed" }),
            cell: ({ getValue }) => (
                <span className={`px-2 py-1 rounded text-xs ${getValue() ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700'}`}>
                    {getValue() ? t("yes", { defaultValue: "Yes" }) : t("no", { defaultValue: "No" })}
                </span>
            )
        },
        {
